...
<div class="container">
  <div class="categories">
    <a href="#shopmenu"> <h1>Categories</h1></a>
      <ul>
  ...
  <div class="products">
    ...
    $query = "SELECT id_product, product_name, price, description, picture_product FROM product";
...
<script>
    function showProductPrice(productId) {
