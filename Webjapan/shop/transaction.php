...
$query_mysql = mysqli_query($mysqli, "SELECT orders.*, product.product_name, product.picture_product FROM orders INNER JOIN product ON orders.id_product = product.id_product ORDER BY order_date ASC") or die(mysqli_error($mysqli));
$nomor = 1;
while ($data = mysqli_fetch_array($query_mysql)) {
    ...
    <tr>
        ...
        <td><img src="../../Webjapan/image/<?php echo $data['picture_product']; ?>" alt="<?php echo $data['product_name']; ?>" style="width:100px; height:auto;"></td>
    </tr>
<?php } ?>
