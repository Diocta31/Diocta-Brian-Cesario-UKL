...
<section id="hero">
    ...
    <a href="#craft" class="button">Get It Now</a>
</section>

<div class="subtitle" id="craft">
...
<div class="container">
  ...
  <div class="products">
    ...
    $query = "SELECT id_product, product_name, price, description, picture_product FROM product WHERE category = 'craft'";
