...
<section id="hero">
    ...
    <a href="#clothing" class="button">Get It Now</a>
</section>

<div class="subtitle" id="clothing">
...
<div class="container">
  ...
  <div class="products">
    ...
    $query = "SELECT id_product, product_name, price, description, picture_product FROM product WHERE category = 'clothing'";
