...
<section id="hero">
    ...
    <a href="#cutlery" class="button">Get It Now</a>
</section>

<div class="subtitle" id="cutlery">
...
<div class="container">
  ...
  <div class="products">
    ...
    $query = "SELECT id_product, product_name, price, description, picture_product FROM product WHERE category = 'cutlery'";
