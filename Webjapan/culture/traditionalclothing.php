...
$query = "SELECT article.title, article.article_content, article.picture_article, article_categories.name AS category_name
          ...
          WHERE article.category_name = 'Traditional_Clothing'";
...
<head>
    ...
    <link rel="stylesheet" href="traditionalclothing.css">
...
<section id="hero" class="hero">
    <a href="#traditionalclothing" class="button">EXPLORE</a>
</section>

<div class="subtitle" id="traditionalclothing">
</div>
  ...
  <div class="categories">
    ...
    <ul>
      ...
      <?php 
        $hasClothing = false;
        foreach ($rows as $row) {
          if ($row['category_name'] === 'Traditional_Clothing') {
            $hasClothing = true;
            break;
          }
        }
