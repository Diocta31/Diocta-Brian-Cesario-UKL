...
<nav class="navbar">
    ...
    <section class="user">
        <a href="adminproductadd.php" class="btn">Add Produk</a>
...
// Mengurutkan berdasarkan kolom id_product dengan urutan menurun (terbaru ke terlama)
$query_mysql = mysqli_query($mysqli, "SELECT * FROM product ORDER BY id_product DESC") or die(mysqli_error($mysqli));
...
?>
    <tr>
        ...
        <td><img src="image/<?php echo $data["picture_product"]; ?>" width="200" title="<?php echo $data['picture_product']; ?>"></td>
        <td class="action"><a href="adminproductdelete.php?id=<?= $data["id_product"]; ?>"
                    onclick="return confirm('Are you sure want to delete this data?');" class="btn"
                    style=" margin:5px; padding:10px; ">Delete</a> </td>
        <td class="action"><a href="adminproductedit.php?id=<?php echo $data['id_product']; ?>" class="btn-update">Update</a></td>
    </tr>
<?php } ?>
