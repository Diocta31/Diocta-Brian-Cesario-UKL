...
<body>
    ...
    <section class="user">
        ...
        <table border="1" class="table">
            ...
            $query_mysql = mysqli_query($mysqli, "SELECT * FROM users ORDER BY id_user DESC") or die(mysqli_error($mysqli));
            $nomor = 1;
            while ($data = mysqli_fetch_array($query_mysql)) {
                ...
                <tr>
                    ...
                    <td class="action"><a href="admindelete.php? id=<?= $data["id_user"]; ?>"
                                onclick="return confirm('Are you sure want to delete this data?');" class="btn"
                                style=" margin:5px; padding:10px; ">Delete</a> </td>
                    <td clas="action"><a href="adminuserupdate.php?id=<?php echo $data['id_user']; ?>" class="btn-update">Update</a> </td>
                </tr>
            <?php } ?>
        </table>
